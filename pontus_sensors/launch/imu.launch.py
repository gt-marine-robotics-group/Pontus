...
def generate_launch_description():
  ...
  launch_description.append(DeclareLaunchArgument('params_file', default_value=_PONTUS_PARAMS_FILE, description='Path to file that will load additional parameters'))
