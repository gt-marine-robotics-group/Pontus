...
class SlalomPair:
    ...
    """
    red_slalom: ThresholdDetection
    white_slalom: ThresholdDetection
    ...
    def __iter__(self) -> Iterator[ThresholdDetection]:
    ...
    def __getitem__(self, idx: int) -> ThresholdDetection:
        if idx == 0:
...
def select_target_slaloms(
        white_slaloms: List[ThresholdDetection],
        red_slaloms: List[ThresholdDetection],
