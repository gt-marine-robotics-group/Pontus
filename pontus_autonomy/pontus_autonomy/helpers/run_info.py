...
waypoints_list: list[PoseObj] = [
    ...
    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5, depth=0.0),

    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5),

    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5, yaw_degrees=00),
    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5, yaw_degrees=90.0),
    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5, yaw_degrees=180.0),
    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5, yaw_degrees=270.0),
    make_waypoint(GATE_CENTER_X, GATE_CENTER_Y + 2.5, yaw_degrees=360.0),
